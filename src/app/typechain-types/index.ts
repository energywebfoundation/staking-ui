...
export type { IClaimManager } from './contracts/libs/IClaimManager';
export { IClaimManager__factory } from './factories/contracts/libs/IClaimManager__factory';
export type { SnapshotsRewarder } from './contracts/SnapshotsRewarder';
export { SnapshotsRewarder__factory } from './factories/contracts/SnapshotsRewarder__factory';
