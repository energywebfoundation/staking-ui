...
export const snapshotInfo = new Map<RoleEnrolmentStatus, SnapshotInfo>()
  .set(RoleEnrolmentStatus.NOT_ENROLED, {
    ...
    message:
      'Check if you are included in the snapshot by clicking on the grey circle above!',
  ...
  .set(RoleEnrolmentStatus.ENROLED_SYNCED, {
    ...
    message:
      'Make sure you keep your Energy Web Tokens staked to be eligible for future snapshots, more information about the snapshots',
  ...
  .set(RoleEnrolmentStatus.REJECTED, {
    ...
    message:
      "Make sure you don't miss out on the following snapshots, you need to stake your Energy Web Tokens to be eligible for the snapshots, more information about the snapshots",
    link: 'https://medium.com/energy-web-insights/energy-web-community-staking-pool-snapshots-explained-3a9c3eebf28b',
    cssClass: 'rejected',
  })
  ...
  .set(RoleEnrolmentStatus.SNAPSHOT_NOT_TAKEN, {
    ...
    message:
      'Stake your Energy Web Tokens to be eligible for snapshots, more information about the snapshots',
    link: 'https://medium.com/energy-web-insights/energy-web-community-staking-pool-snapshots-explained-3a9c3eebf28b',
    cssClass: 'not-taken',
  })
